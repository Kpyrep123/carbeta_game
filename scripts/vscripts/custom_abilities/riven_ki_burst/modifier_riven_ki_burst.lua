...
function modifier_riven_ki_burst:OnCreated( kv )
	-- references
	self.stun_duration = self:GetAbility():GetSpecialValueFor( "stun_duration" ) + self:GetCaster():GetTalentValue("spec_riven_crit")
	self.bonus_damage = self:GetAbility():GetSpecialValueFor( "bonus_damage" )
	self.radius = self:GetAbility():GetSpecialValueFor( "radius" ) + self:GetCaster():GetTalentValue("spec_riven_ki_rad")
