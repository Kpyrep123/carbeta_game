...
function midas_golden_touch:OnSpellStart( kv )
	...
	local radiusnotshard = self:GetSpecialValueFor("radiusnotshard")
	local center = target:GetAbsOrigin()
	local enemies = FindUnitsInRadius(caster:GetTeamNumber(), center, nil, radius, DOTA_UNIT_TARGET_TEAM_ENEMY, DOTA_UNIT_TARGET_ALL, DOTA_UNIT_TARGET_FLAG_NONE, FIND_ANY_ORDER, false)
	local enemiesnotshard = FindUnitsInRadius(caster:GetTeamNumber(), center, nil, radiusnotshard, DOTA_UNIT_TARGET_TEAM_ENEMY, DOTA_UNIT_TARGET_ALL, DOTA_UNIT_TARGET_FLAG_NONE, FIND_ANY_ORDER, false)
	-- load data
...
for _,enemy in pairs(enemies) do
	enemy:AddNewModifier(
		...
		for _,enemy in pairs(enemiesnotshard) do
	enemy:AddNewModifier(
		caster, -- player source
		self, -- ability source
		"modifier_midas_golden_touch", -- modifier name
