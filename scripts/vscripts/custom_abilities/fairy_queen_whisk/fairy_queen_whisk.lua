...
function fairy_queen_whisk:OnSpellStart()
	...
	local ally_radius = self:GetSpecialValueFor( "ally_radius" )
	local enemy_radius = self:GetSpecialValueFor( "enemy_radius" )
	local buff_duration = self:GetSpecialValueFor( "buff_duration" ) + self:GetCaster():GetTalentValue("spec_blink_dur")
	local debuff_duration = self:GetSpecialValueFor( "debuff_duration" ) + self:GetCaster():GetTalentValue("spec_blink_dur")
