...
function fire_remnant_add_location( keys )
	...
	local dummy = CreateUnitByName( "npc_dota_void_remnant", caster:GetAbsOrigin(), false, caster, nil, caster:GetTeamNumber() )
	...
	local ability1 = caster:FindAbilityByName("luna_void_blast")
	local ability2 = caster:FindAbilityByName("luna_void_beam")
	ability1:SetLevel(4)
	ability2:SetLevel(4)
	dummy:AddAbility("ability1")
	dummy:AddAbility("ability2")
	-- Add dummy to table
