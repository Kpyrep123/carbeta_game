sobek_burrowstrike_lua = class({})
LinkLuaModifier( "modifier_sand_king_burrowstrike_lua", "heroes/sobek/borrow/modifier_sand_king_burrowstrike_lua", LUA_MODIFIER_MOTION_NONE )
...
--------------------------------------------------------------------------------
-- Ability Start
function sobek_burrowstrike_lua:OnSpellStart()
	-- unit identifier
...
--------------------------------------------------------------------------------
-- Projectile
function sobek_burrowstrike_lua:OnProjectileHit( target, location )
...
--------------------------------------------------------------------------------
function sobek_burrowstrike_lua:PlayEffects( origin, target )
	-- Get Resources
