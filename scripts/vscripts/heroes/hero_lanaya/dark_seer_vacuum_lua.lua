...
LinkLuaModifier( "modifier_dark_seer_vacuum_lua", "heroes/hero_lanaya/modifier_dark_seer_vacuum_lua.lua", LUA_MODIFIER_MOTION_HORIZONTAL )

--------------------------------------------------------------------------------
-- Init Abilities
function dark_seer_vacuum_lua:Precache( context )
	PrecacheResource( "soundfile", "sounds/weapons/hero/templar_assassin/trap_explode.vsnd", context )
	PrecacheResource( "particle", "particles/templar_assassin_trap_explode_custom.vpcf", context )
end
...
function dark_seer_vacuum_lua:PlayEffects( point, radius )
	-- Get Resources
	local particle_cast = "particles/templar_assassin_trap_explode_custom.vpcf"
	local sound_cast = "sounds/weapons/hero/templar_assassin/trap_explode.vsnd"
