...
if false and control == false then 
    ...
    if enemy_for_ability[1] ~= nil  then 
...
if ((thisEntity:GetAbsOrigin() - thisEntity.spawn):Length2D() < thisEntity.spawn_radius ) and enemy ~= nil then 
