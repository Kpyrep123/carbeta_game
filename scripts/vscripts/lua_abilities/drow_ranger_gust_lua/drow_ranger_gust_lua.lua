...
function drow_ranger_gust_lua:OnSpellStart()
	...
	local width = self:GetSpecialValueFor( "wave_width" ) + self:GetCaster():GetTalentValue("special_bonus_unquie_gust_width")
...
function drow_ranger_gust_lua:GetCooldown( level )
	local upgrade_cooldown = 0 
	local talent = self:GetCaster():FindAbilityByName("special_bonus_unquie_gust_cd")
