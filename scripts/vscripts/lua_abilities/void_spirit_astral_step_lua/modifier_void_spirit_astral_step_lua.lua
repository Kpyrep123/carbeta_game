...
function modifier_void_spirit_astral_step_lua:OnDestroy()
	...
	local counter_buff = self:GetCaster():FindModifierByName("modifier_warpath_datadriven_counter")
	local subab = self:GetCaster():FindAbilityByName("luna_void_blast")
	subab:ApplyDataDrivenModifier(self:GetCaster(), self:GetCaster(), "modifier_warpath_datadriven_counter", {})
