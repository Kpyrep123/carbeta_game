...
function invoker_ice_wall_datadriven_on_spell_start(keys)
	...
	for i=0, keys.NumWallElements, 1 do
		local ice_wall_unit = CreateUnitByName("npc_dummy_unit_inv", one_end_point + direction_to_target_point_normal * (keys.WallElementSpacing * i), false, nil, nil, keys.caster:GetTeam())
