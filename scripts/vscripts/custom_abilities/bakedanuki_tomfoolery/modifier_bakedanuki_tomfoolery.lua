...
function modifier_bakedanuki_tomfoolery:OnCreated( kv )
	...
	self.illusion_outgoing = self:GetAbility():GetSpecialValueFor( "illusion_outgoing" ) + self:GetCaster():GetTalentValue("special_bonus_unquie_bakedanuki_tomfoolery_blink")
