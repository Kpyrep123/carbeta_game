...
function modifier_huskar_berserkers_blood_lod:OnCreated()
	...
	self.berserkers_blood_hurt_health_ceiling = 0.90--self:GetAbility():GetSpecialValueFor("hurt_health_ceiling")
	self.berserkers_blood_hurt_health_floor = 0.05--self:GetAbility():GetSpecialValueFor("hurt_health_floor")
	self.berserkers_blood_hurt_health_step = 0.05--self:GetAbility():GetSpecialValueFor("hurt_health_step")
...
function modifier_huskar_berserkers_blood_lod:OnRefresh()
	self.berserkers_blood_damage = self:GetAbility():GetSpecialValueFor( "damage_per_stack" )
	self.berserkers_blood_attack_speed = self:GetAbility():GetSpecialValueFor( "attack_speed_bonus_per_stack" )
	self.berserkers_blood_move_speed = self:GetAbility():GetSpecialValueFor( "move_speed_bonus_per_stack")
...
function modifier_huskar_berserkers_blood_lod:GetModifierMoveSpeedBonus_Constant ( params )
