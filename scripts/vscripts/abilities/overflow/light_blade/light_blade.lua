...
function light_blade:GetAOERadius()
	return self:GetSpecialValueFor("aoe_range" + self:GetCaster():GetTalentValue("special_bonus_unique_laguna_range")) + self:GetCaster():GetTalentValue("special_bonus_unique_laguna_range")
end
