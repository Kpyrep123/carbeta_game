...
function CastSpirits2( event )
	...
	ability.spirits_numSpirits		= 0		-- Use this rather than "#spirits_spiritsSpawned"
	ability.spirits_spiritsSpawned	= {}
	caster.spirits_radius			= event.default_radius2
	caster.spirits_movementFactor	= 0		-- Changed by the toggle abilities


end
function CastSpirits3( event )
	...
	ability.spirits_numSpirits		= 0		-- Use this rather than "#spirits_spiritsSpawned"
	ability.spirits_spiritsSpawned	= {}
	caster.spirits_radius			= event.default_radius3
	caster.spirits_movementFactor	= 0		-- Changed by the toggle abilities


end
function CastSpirits4( event )
	...
	ability.spirits_numSpirits		= 0		-- Use this rather than "#spirits_spiritsSpawned"
	ability.spirits_spiritsSpawned	= {}
	caster.spirits_radius			= event.default_radius4
	caster.spirits_movementFactor	= 0		-- Changed by the toggle abilities
