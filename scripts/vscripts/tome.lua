...
function UpgradeStats(keys)
	...
	_G.Players[caster:GetPlayerOwnerID() ] = _G.Players[caster:GetPlayerOwnerID() ] or {}
	_G.Players[caster:GetPlayerOwnerID() ].books = _G.Players[caster:GetPlayerOwnerID() ].books or 0
	_G.Players[caster:GetPlayerOwnerID() ].books = _G.Players[caster:GetPlayerOwnerID() ].books + cost
