...
function mod:OnDestroy()
	...
	ParticleManager:CreateParticle("particles/units/heroes/hero_riki/riki_tricks_dagger_group.vpcf", PATTACH_ABSORIGIN, parent)
...
function mod:GetEffectName()
	return "particles/units/heroes/hero_nevermore/nevermore_trail.vpcf"
end
