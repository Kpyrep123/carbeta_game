...
function modifier_huntress_owl_unit_vision:GetAuraRadius()
    return self:GetAbility():GetSpecialValueFor("radius") + self:GetAbility():GetCaster():GetTalentValue("huntress_huntress_owl_radius_aura_tallent")
end
...
function modifier_huntress_owl_unit_vision:GetBonusDayVision()
    return self:GetAbility():GetCaster():GetTalentValue("huntress_huntress_owl_radius_aura_tallent")
end
...
function modifier_huntress_owl_unit_vision:OnIntervalThink()
    ...
    local enemyUnits = FindUnitsInRadius(hero:GetOpposingTeamNumber(),
        hero:GetAbsOrigin(),
        nil,
        self:GetAbility():GetSpecialValueFor("radius") + self:GetAbility():GetCaster():GetTalentValue("huntress_huntress_owl_radius_aura_tallent"),
