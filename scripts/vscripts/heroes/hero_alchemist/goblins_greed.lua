...
function GoblinsGreed( event )
	...
	local bonus_bonus_gold = ability:GetSpecialValueFor( "bonus_bonus_gold")
	local bonus_gold_cap = ability:GetSpecialValueFor( "bonus_gold_cap")
...
function GoblinsGreedBaseBonus( event )
	...
	local ability = event.ability
	local bonus_gold = ability:GetSpecialValueFor( "bonus_gold")
	local bonus_gold_former_level = ability:GetSpecialValueFor( "bonus_gold")
