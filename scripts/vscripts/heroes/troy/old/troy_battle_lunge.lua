...
function troy_battle_lunge:OnSpellStart()
	if IsServer() then
		...
		caster:EmitSound("Hero_Jeremy.BattleLunge.Leap")
...
function modifier_battle_lunge_motion:OnDestroy()
	if IsServer() then
		...
		-- Play impact sound
		caster:StopSound("Hero_Jeremy.BattleLunge.Leap")
		caster:EmitSound("Hero_Jeremy.BattleLunge.Impact")
...
function modifier_battle_lunge_status_resist:GetCustomTenacity()
