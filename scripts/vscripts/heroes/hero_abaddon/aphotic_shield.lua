...
function AphoticShield( event )
	...
	local shield_size = 500 -- could be adjusted to model scale
	...
	Timers:CreateTimer(0.01, function() 
		target.ShieldParticle = ParticleManager:CreateParticle("particles/hero/tinker/rearmshield_shield.vpcf", PATTACH_ABSORIGIN_FOLLOW, target)
		...
		ParticleManager:SetParticleControl(target.ShieldParticle, 3, Vector(shield_size,0,shield_size))
