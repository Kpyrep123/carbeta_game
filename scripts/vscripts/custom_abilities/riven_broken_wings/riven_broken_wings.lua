...
function riven_broken_wings:OnSpellStart()
	...
	-- load data
	local range = self:GetSpecialValueFor("range") + self:GetCaster():GetTalentValue("spec_riven_crit_dur")
	local width = self:GetSpecialValueFor("width")
	local damage = self:GetSpecialValueFor("bonus_damage") + self:GetCaster():GetTalentValue("spec_riven_damage")
	local recast_timer = self:GetSpecialValueFor("recast_timer")
	local recast_number = self:GetSpecialValueFor("recast_number") + self:GetCaster():GetTalentValue("spec_riven_rush")
